...
router.post("/generate", ensurePaid, async (req, res) => {
  try {
    ...
    const sys = "You are a senior proposal writer. Write concise, persuasive tenders with clear sections: 1. Executive Summary, 2. Understanding of Requirements, 3. Technical Approach & Methodology, 4. Team & Relevant Experience, 5. Timeline, 6. Pricing (range or model), 7. Compliance Matrix (short), 8. Risks & Mitigations, 9. Closing & Next Steps. Tone: confident, specific, verifiable. Avoid fluff.";

    const userPrompt = "TENDER TEXT:\n" + inputText + "\n\nCOMPANY PROFILE:\n" + companyBrief + "\n\nPersona (optional): " + (persona || "general B2B IT vendor") + "\n\nTASK:\nWrite a complete draft proposal tailored to the tender text and company profile. Return JSON with: { \"title\": \"string\", \"sections\": [{ \"heading\": \"Executive Summary\", \"content\": \"...\" }, ...], \"closing\": \"short closing paragraph\" }\n\nKeep it 1,000-1,800 words, concrete and tender-specific.";
